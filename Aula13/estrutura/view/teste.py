import sys
sys.path.append('C:/Users/900217/Desktop/Aula13/estrutura')
...
dao_papel = Papel()
# dao_cotacao = CotacaoDiaria

for cd in dao_cd.list_pl():
    print(f'Código: {cd.papel.codigo} \nDescrição: {cd.papel.descricao} \nValor de fechamento: {cd.valor_fechamento} \nLPA: {cd.lpa} \n\033[1;33mPL: {round(cd.pl , 2)} \033[0;0m\n')